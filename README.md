...
For a complete working example, see the [demo](https://helioviewer-project.github.io/event-tree/) which demonstrates how to integrate the component into a React application with Vite. The main implementation is in [App.jsx](https://github.com/Helioviewer-Project/event-tree/blob/main/examples/react/src/App.jsx).
